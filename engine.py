...
def train_one_epoch(
    ...
    for batch_idx, batch_data_label in enumerate(dataset_loader):
        ...
        # print(next(model.mlp_heads.sem_cls_head.layers[0].parameters()).requires_grad)
        ...
        if args.clip_gradient > 0:
            torch.nn.utils.clip_grad_norm_([p for p in model.parameters() if p.requires_grad == True], args.clip_gradient)
        optimizer.step()
